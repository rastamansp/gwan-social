...
**Estado atual:** o **E6 (web)** tem já um **protótipo rico** em `apps/web` (mocks, sem `/v1`); as histórias **H8/H9** mantêm-se válidas para a fase em que clientes consumirem a API. O **mobile** ainda não existe no repositório.
